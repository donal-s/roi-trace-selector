...
// describe("getWasmMinimumStdevStatus", () => {

//   let getWasmMinimumStdevStatus:  (selectedTraceCount: number, chartData: number[][]) => MinimumStdevResult;

//   beforeAll(async () => {
//     const instance = await instantiate(await WebAssembly.compileStreaming(fetch("./debug.wasm")))
//     getWasmMinimumStdevStatus = instance.getWasmMinimumStdevStatus;
//   })

//   it("minimum stdev selection by trace count - 4 traces", async () => {
//     expect(
//       getWasmMinimumStdevStatus(4, EXPECTED_CHANNEL1_DATASET.chartData)
//     ).toEqual({
//       scanStatus: [
//         SCANSTATUS_SELECTED,
//         SCANSTATUS_SELECTED,
...
//     expect(
//       getWasmMinimumStdevStatus(3, EXPECTED_CHANNEL1_DATASET.chartData)
//     ).toEqual({
//       scanStatus: [
//         SCANSTATUS_UNSELECTED,
//         SCANSTATUS_SELECTED,
...
//   it("minimum stdev selection by trace count - 2 traces", async () => {
//     expect(
//       getWasmMinimumStdevStatus(2, EXPECTED_CHANNEL1_DATASET.chartData)
//     ).toEqual({
//       scanStatus: [
//         SCANSTATUS_UNSELECTED,
//         SCANSTATUS_SELECTED,
...
//     expect(
//       getWasmMinimumStdevStatus(1, EXPECTED_CHANNEL1_DATASET.chartData)
//     ).toEqual({
//       scanStatus: [
//         SCANSTATUS_UNSELECTED,
//         SCANSTATUS_UNSELECTED,
